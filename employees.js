...
class Employee {
    constructor(names,shifts){
        ...
        getSchedule(){
            console.log(this.names,'works',this.shifts)
        }
...
//CODE HERE
let empOne = new Employee('Nicholas ','weekday afternoons')
...
// //CODE HERE
 const manager = new Manager ('Shelby','weekday mornings,weekday afternoons','Cece and Scmidt')
